...
final class PackageCollectionTest extends TestCase
{
    ...
    public function sortsComposerPackages(): void
    {
        ...
        self::assertSame(6, array_search('package0', array_keys($result)), 'Package 0 is not stored at loading order 5.');
        self::assertSame(7, array_search('package1', array_keys($result)), 'Package 1 is not stored at loading order 6.');
        self::assertSame(8, array_search('extension_unsynced_extemconf', array_keys($result)), 'extension_unsynced_extemconf is not stored at loading order 7.');
        self::assertSame(9, array_search('extension_with_extemconf', array_keys($result)), 'extension_with_extemconf is not stored at loading order 8.');
        self::assertSame(10, array_search('extension2_unsynced_extemconf', array_keys($result)), 'extension2_unsynced_extemconf is not stored at loading order 9.');
        self::assertSame(11, array_search('package2', array_keys($result)), 'Package 2 is not stored at loading order 10.');
