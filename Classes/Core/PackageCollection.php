...
class PackageCollection
{
    ...
    protected ComposerPackageManager $composerPackageManager;
    ...
    public function __construct(
        ...
        $this->composerPackageManager = $composerPackageManager;
    ...
    public function resolveSortedPackageKeys(?DependencyOrderingService $dependencyOrderingService = null): array
    {
        ...
        $reflectionClass = new \ReflectionClass(DependencyOrderingService::class);
        ...
        $frameworkDependencyGraph = $reflectionClass->getMethod('buildDependencyGraph')->invoke(
        ...
        $dependencyGraph = $reflectionClass->getMethod('buildDependencyGraph')->invoke(
            $dependencyOrderingService,
